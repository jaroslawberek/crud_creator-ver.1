...
@forelse($<*<controller>*> as $<*<model>*>)
            <tr>
                ...
                <td >
                    <div class="btn-group btn-group-crud-table " role="group" aria-label="">
                        ...
                        <a href="{{route('<*<controller>*>.edit',['id'=>$<*<model>*>->id ?? ''])}}" class="btn-primary btn-crud-table" >
                            <span class= "fa fa-edit bt-crud-table-icon"></span> 
                            <span class="bt-crud-table-text"></span>
                        </a>
                        <a href="{{route('destroy-<*<model>*>',['id'=>$<*<model>*>->id ?? ''])}}" class="btn-primary btn-crud-table" >
            ...
            @empty
            <tr>
                <td colspan="<*<col_count>*>" style='text-align: center; padding: 100px'>Brak rekordow</td>          
            </tr>
@endforelse 
